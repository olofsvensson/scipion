...
#ifndef _PROG_MONOTOMO_RES
#define _PROG_MONOTOMO_RES
...
public:
	 /** Filenames */
	FileName fnOut, fnOdd, fnEven, fnMask, fnchim, fnSpatial, fnSym, fnTomo, fnMaskOut, fnMd;
...
public:
	...
	MultidimArray< std::complex<double> > fftVol, fftNoiseVol, fftV, *fftN; // Fourier transform of the input volume
